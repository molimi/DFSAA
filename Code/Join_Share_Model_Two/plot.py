...
def fig_snp(weights, top_k, features, set_index, save_path):
    ...
    file_name3 = str(set_index) + "_vbm_weights-231212.txt"
    ...
    print("********************************\n")
    file_name4 = str(set_index) + "_vbm_roi-231212.txt"
    ...
    plt.switch_backend('agg')           # Unable to display pictures when calling remote server
    fig = plt.figure()
    ax1 = fig.subplots()
    ...
    file_name5 = str(set_index) + "_vbm_weights-231212.png"
