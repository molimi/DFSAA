...
def inplace_prox_D(alpha, beta, theta, lambda_, lambda_bar, M):
    alpha_beta = torch.cat([alpha.weight.data, beta.weight.data])       # Merge optimization
...
def inplace_prox_A(beta, theta, lambda_, lambda_bar, M):
